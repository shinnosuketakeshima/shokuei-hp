...
export const PAGE_META = {
  ...
  '/student-column-4': {
    title: '学生コラム：夢を掴む夏の「寺子屋」へ。国試模試に挑む食えい生たちの熱い自習室 | 食物栄養学科',
    description: '十文字学園女子大学 食物栄養学科で今週末実施される、夏の特別集中講座「寺子屋」の選抜を兼ねた管理栄養士国家試験模擬試験。ボロボロの参考書と付箋だらけの過去問集を武器に、仲間と高め合いながら挑む学生たちの熱い夏を学生記者がレポートします。',
    ogType: 'article',
  },
  '/student-column-1': {
