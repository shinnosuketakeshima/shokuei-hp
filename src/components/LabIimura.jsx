...
const RESEARCH_THEMES = [
  {
    ...
    body: 'ゼブラフィッシュやキンギョは、哺乳類に似た組織を持ちながら、安価・短期間で実験できる優れた研究モデル。食品成分の骨・皮膚への効果を調べる「スクリーニング系」の構築を目指しています。',
  },
  {
    icon: Microscope,
    tag: 'テーマ 02',
...
const GRADUATION_TOPICS = [
  ...
  'ゼブラフィッシュ・キンギョを用いた食品成分の骨・皮膚への作用評価',
];
        ...
        <div className="lab-page__content">
          ...
          >
            ...
            <p className="lab-story-feature__lead">
              ...
              <strong>ゼブラフィッシュやキンギョなどの小型魚類</strong>を使って、骨や皮膚の再生、
          ...
          >
            ...
            <p className="lab-section__body">
              ...
              ゼブラフィッシュやキンギョなどの小型魚類は、低コストで飼育でき、
