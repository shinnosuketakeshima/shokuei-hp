...
const CURRICULUM = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '後期', detail: '学生同士での栄養相談（カウンセリング）の練習がスタート。病気についての理解を深め、増粘剤を用いた飲料の粘度測定など、現場に近い実習も行います。' }
    ],
                  ...
                  <div className="roadmap-text">
                    ...
                    <div style={{ padding: '20px', background: 'var(--bg)', borderRadius: '12px', borderLeft: '4px solid var(--forest)' }}>
                      ...
                      <p style={{ fontSize: '14px', color: 'var(--charcoal)' }}>
                        ...
                        {activeYear === 1 && '解剖生理学、食品加工学、病態生理学、栄養相談実習'}
                        {activeYear === 2 && '臨床栄養学、公衆栄養学、給食経営管理、スポーツ栄養学'}
