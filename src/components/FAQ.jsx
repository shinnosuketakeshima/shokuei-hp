  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '学べます。食物栄養学科には「スポーツ栄養学（石津達野先生）」「運動生理学（長浜尚史先生）」「スポーツコーチング論」が学科内科目として設置されており、管理栄養士を目指しながらスポーツ栄養の専門知識を身につけられます。さらに「他学科開放制度」を活用すれば、健康栄養学科の日本スポーツ栄養学会理事・村田浩子教授や、現役公認スポーツ栄養士・徳野裕子准教授の講義も受講可能です。管理栄養士の国試対策とスポーツ栄養を同時に学べるのは、十文字学園ならではの強みです。',
      ...
      },
      {
        ...
        a: '公認スポーツ栄養士は日本栄養士会と日本スポーツ協会が共同認定する、非常に専門性の高い資格です。受験には「管理栄養士免許の所持」が必須条件で、そのうえで所定の研修（スポーツ栄養ベーシックコース修了）と実務経験を積むことで受験資格が得られます。段階的なプロセスを要する本格的な資格ですが、食物栄養学科の充実した国家試験対策サポート体制を活かしながら、他学科開放でスポーツ栄養を並行して学ぶことで、確実にその道を歩むことができます。',
        link: '/sports-nutrition',
