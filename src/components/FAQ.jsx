  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '学べます。食物栄養学科には「スポーツ栄養学（石津達野先生）」「運動生理学（長浜尚史先生）」「スポーツコーチング論」が学科内科目として設置されており、管理栄養士を目指しながらスポーツ栄養の専門知識を身につけられます。さらに副担任制度を活用すれば、健康栄養学科が主催するゼミを通じて日本スポーツ栄養学会理事・村田浩子教授や現役公認スポーツ栄養士・徳野裕子准教授のもとでスポーツの現場に立ち、実践的なスポーツ栄養を体験することもできます。',
