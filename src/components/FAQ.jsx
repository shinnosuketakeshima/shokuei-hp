  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '学べます。食物栄養学科には「スポーツ栄養学（石津達野先生）」「運動生理学（長浜尚史先生）」が学科内科目として設置されており、管理栄養士を目指しながらスポーツ栄養の専門知識を身につけられます。さらに「他学科開放制度」を活用すれば、健康栄養学科の日本スポーツ栄養学会理事・村田浩子教授や、現役公認スポーツ栄養士・徳野裕子准教授の講義も受講可能です。管理栄養士の国試対策とスポーツ栄養を同時に学べるのは、十文字学園ならではの強みです。',
