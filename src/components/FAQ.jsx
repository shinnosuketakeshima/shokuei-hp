...
const FAQ_CATEGORIES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '埼玉県新座市菅沢2-1-28にあります。東武東上線・志木駅からスクールバスが運行しており、東京都内や埼玉各地から通いやすいアクセスです。',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: '十文字学園女子大学 食物栄養学科は全国平均を上回る合格実績を維持しています。1年次からの早期意識づけ、4年次の年8回模擬試験、外部講師による特別講義など6段階のサポート体制が支えています。',
      },
      {
        id: 'e2',
        q: '国家試験対策はいつから始まりますか？',
