...
const FEATURES = [
  {
    ...
    icon: <Award size={20} />,
    title: '全国唯一のダブルライセンス',
    body: '管理栄養士養成課程の中で「第一種衛生管理者」の国家資格を取得できるのは、全国の大学で本学のみ。50名以上の事業場で配置が義務付けられており、企業の産業保健分野への就職に大きく有利です。',
  },
  {
    num: '02',
    icon: <Users size={20} />,
    title: '定員78名の少人数教育',
    body: '少人数だからこそできる、きめ細かな指導。教員が一人ひとりの学習状況を早期に把握し、入学から卒業・就職まで親身にサポートします。就職率99.2%はこの環境から生まれています。',
  },
  {
    num: '03',
