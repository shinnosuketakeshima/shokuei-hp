...
const EVIDENCE_CARDS = [
  {
    ...
    body: '日本スポーツ栄養学会理事・村田浩子教授、公認スポーツ栄養士・徳野裕子准教授ら、国内トップクラスのスポーツ栄養専門家が同じ大学の健康栄養学科に在籍。副担任制度を活用することで、健康栄養学科が主催するゼミを通じ、食物栄養学科の学生もスポーツの現場に立ち、スポーツ栄養の実践を体験することができます。',
    accent: 'var(--forest)',
  },
  {
    num: '02',
        ...
        <div className="lab-page__content">
          ...
          >
            ...
            <p className="lab-story-feature__lead">
              ...
              さらに<strong>副担任制度</strong>を活用することで、
          ...
          <motion.section className="lab-section" {...fadeUp(0.05)}>
            ...
            <p className="lab-section__body">
              ...
              <strong>副担任制度</strong>を活用することで、健康栄養学科が主催するゼミを通じて
