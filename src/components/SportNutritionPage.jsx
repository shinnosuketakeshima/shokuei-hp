...
const EVIDENCE_CARDS = [
  {
    ...
    body: '日本スポーツ栄養学会理事・村田浩子教授、公認スポーツ栄養士・徳野裕子准教授ら、国内トップクラスのスポーツ栄養専門家が同じ大学の健康栄養学科に在籍。本格的なスポーツ栄養教育を展開できる専門的な環境が整っています。',
    accent: 'var(--forest)',
  },
  {
    num: '02',
        ...
        <div className="lab-page__content">
          ...
          >
            ...
            <p className="lab-story-feature__lead">
              ...
              さらに同じ大学には、健康栄養学科を中心に国内最高峰のスポーツ栄養専門家も在籍しており、
              スポーツ栄養をより深く探究できる充実した専門的環境が整っています。<br /><br />
          ...
          <motion.section className="lab-section" {...fadeUp(0.05)}>
            ...
            <p className="lab-section__body">
              ...
              加えて、十文字学園女子大学の健康栄養学科には国内最高峰のスポーツ栄養専門家も在籍しています。
            </p>
