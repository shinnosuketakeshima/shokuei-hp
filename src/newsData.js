export const STATIC_NEWS = [
  {
    ...
    hook: '病院や高齢者施設での臨地実習を終えた学生たちが、給食管理の緊張感、施設ごとに異なる支援、現場で得た自信について語った座談会レポート。',
    href: '/student-column-5',
  },
  {
    id: 'col6',
    date: '2026.9.12',
    ...
    hook: '好きなたれがあればご飯が食べられる。高齢者施設で学生が出会った、栄養価だけでは答えが出ない食支援の話です。',
    href: '/student-column-6',
  },
  {
    id: 'col7',
    date: '2026.9.11',
    ...
    hook: '食事内容の変更、食形態の違い、温度管理、最終確認。限られた時間で一人ひとりに安全な食事を届ける現場を学生がレポート。',
    href: '/student-column-7',
  },
  {
    id: 'col8',
    date: '2026.9.10',
    ...
    hook: '「はたらく細胞の白血球みたい」。真っ白な白衣で臨んだ実習から、身だしなみ、質問する力、実習前の不安を振り返ります。',
    href: '/student-column-8',
  },
  {
    id: 'chair-message',
    date: '2026.9.15',
