...
function App() {
  ...
  useEffect(() => {
    ...
    const subPages = ['#lab-takeshima', '#lab-kamoshita', '#lab-kunii', '#lab-iimura', '#lab-kamiyama', '#lab-ishii', '#lab-komeichi', '#lab-nakaoka', '#lab-shibasaki', '#lab-iwamoto', '#koudai-project', '#kokushi-report']
